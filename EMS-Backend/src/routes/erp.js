...
// Clients
router.route('/clients').get(erp.getClients).post(authorize('superadmin', 'admin', 'accountant'), erp.createClient);
router.route('/clients/:id').put(authorize('superadmin', 'admin', 'accountant'), erp.updateClient).delete(authorize('superadmin', 'admin', 'accountant'), erp.deleteClient);

// Vendors
router.route('/vendors').get(erp.getVendors).post(authorize('superadmin', 'admin', 'accountant'), erp.createVendor);
router.route('/vendors/:id').put(authorize('superadmin', 'admin', 'accountant'), erp.updateVendor).delete(authorize('superadmin', 'admin', 'accountant'), erp.deleteVendor);
