...
const navConfig = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Activity Logs', href: '/reports/logs', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z', roles: ['superadmin', 'admin'] },
    ]
  },
  {
    group: 'System',
    items: [
      ...
      { label: 'Company Approvals', href: '/companies/approvals', icon: 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z', roles: ['superadmin'] },
